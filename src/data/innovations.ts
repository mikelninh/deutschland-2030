...
export const innovations: Innovation[] = [
  {
    ...
    exists: "Wir bauen es: GitLaw — alle 5.936 deutschen Bundesgesetze durchsuchbar, AI-erklärbar, mit RAG-Chat. Live: github.com/mikelninh/gitlaw",
  ...
  },
  {
    ...
    exists: "Wir bauen es: Public Money Mirror hat den MdB Transparenz-Index — 5 Faktoren, Schulnote, live berechnet aus abgeordnetenwatch.de und bundestag.de. github.com/mikelninh/Public-Money-Mirror",
    impact: "transformativ",
    feasibility: "sofort",
    techNeeded: "Pol.is (open source) + Verifizierungssystem + Dashboard. Prototyp existiert in PMM.",
  },
  {
    id: "generations",
    emoji: "👶→👴",
  ...
  },
  {
    ...
    exists: "Public Money Mirror trackt bereits Ausgaben-Anomalien und verdächtige Vergaben. Lobbying-Tracing ist der nächste Schritt. github.com/mikelninh/Public-Money-Mirror",
    impact: "transformativ",
    feasibility: "1-2 Jahre",
