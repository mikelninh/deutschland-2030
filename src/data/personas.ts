...
export const policyScenarios: PolicyScenario[] = [
  {
    id: "schulessen",
    emoji: "🍽️",
    title: "Kostenloses Schulessen für alle",
    description: "Wie Japan (Shokuiku) + Finnland: warmes Mittagessen + Ernährungsbildung in jeder Schule.",
    annualCost: 4.1,
    annualSaving: 8.2,
    reactions: [
      { personaId: "thomas", approval: 55, reason: "Teuer, aber verstehe den Nutzen für Chancengleichheit." },
      { personaId: "claudia", approval: 95, reason: "Endlich! Gleiche Startchancen für alle Kinder." },
      { personaId: "stefan-julia", approval: 90, reason: "Spart uns €150/Monat und die Kinder essen besser." },
      { personaId: "kevin", approval: 98, reason: "Mein Kind hat endlich eine warme Mahlzeit am Tag sicher." },
      { personaId: "ayse", approval: 88, reason: "Gut — aber gibt es Halal-Optionen?" },
      { personaId: "fatima", approval: 85, reason: "Sehr gut für meine Kinder. Aber Halal ist wichtig." },
      { personaId: "frank", approval: 60, reason: "Ok, wenn es alle kriegen und nicht nur bestimmte Gruppen." },
      { personaId: "jan", approval: 50, reason: "Wer bezahlt das? Aber für die Dorf-Kinder wär's gut." },
      { personaId: "heinrich", approval: 40, reason: "Warum soll ich das Schulessen für Millionärskinder bezahlen?" },
      { personaId: "lea", approval: 92, reason: "Hätte mir als Kind geholfen. Jedes Kind verdient das." },
      { personaId: "maria", approval: 70, reason: "Gab's bei uns nicht, aber klingt vernünftig." },
      { personaId: "juergen", approval: 88, reason: "Mein Sohn isst oft nur Toast. Das wäre riesig." },
    ],
  },
  {
    id: "praevention",
